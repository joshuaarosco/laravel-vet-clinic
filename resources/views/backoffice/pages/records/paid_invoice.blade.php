      ...
      <section class="invoice printableArea">
        ...
        <div class="row invoice-info">
          ...
          <div class="col-sm-12 invoice-col mb-15 mt-15">
              <div class="invoice-details row no-margin">
                <div class="col-md-6 col-lg-6">Invoice: <strong>#{{ $invoice->invoice_number }}</strong></div>
                {{-- <div class="col-md-6 col-lg-3"><b>Order ID:</b> FC12548</div> --}}
                {{-- <div class="col-md-6 col-lg-6"><b>Payment Due:</b> 14/08/2023</div> --}}
                <div class="col-md-6 col-lg-6">Status: <strong class="{{ $invoice->status=='Paid'?'text-primary':'text-warning' }}">{{ $invoice->status }}</strong></div>
              </div>
          </div>
        <!-- /.col -->
        </div>
        ...
        <div class="row no-print">
          <div class="col-12">
            ...
            @if(auth()->user()->type == 'patient' AND $record->patient->id == auth()->user()->patient->id AND $invoice->status == 'Pending' AND $total_payment > 0)
